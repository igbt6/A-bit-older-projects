...
// konfiguracja po³¹czeñ RFM70 ************************************
// soft SPI na stm32  na porcieA od PB8 do PB13
#define CE   GPIO_ODR_8
#define CSN  GPIO_ODR_9
#define MOSI GPIO_ODR_10
#define MISO GPIO_ODR_11
#define SCK  GPIO_ODR_12
/*//////////////////////////////////////////////////////*/
#define SPI_PORT 	GPIOB->ODR
#define SPI_PIN		GPIOB->IDR   // czytanie stanu wejscia

// IRQ
//#define RF_IRQDDR	DDRB /* to uzywane dopiero jak bede wykorzystywal zewnetrzne przerwanie */
//#define RF_IRQPIN	PINB /* to uzywane dopiero jak bede wykorzystywal zewnetrzne przerwanie */
//#define IRQ		GPIO_Pin_13		// mo¿na u¿yæ INT0, INT1 lub INT2
					// INT2 - po lekkich zmianach kodu

/*!
 * RF70_UseIRQ = 1 - u¿ywamy przerwañ
...
// zdarzenie do obs³ugi odebranych pakietów
void RFM70_RX_EVENT(void);

void EXTI0_Config(void); // konfiguracja przerwania EXTI0 dla sygnalu IRQ
