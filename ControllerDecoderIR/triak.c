...
void init_TIMER0(void)           // timer do odmierzania czasow dla triaka , uruchamiany tyle razy ile wynosi liczba krokow czyli u mnie 200 razy w czsie trwania polowki (10)ms
